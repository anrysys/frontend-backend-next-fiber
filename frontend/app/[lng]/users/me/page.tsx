...
export default function MePage({ params: { lng } }: {
  params: {
    lng: string;
  };
}) {
  ...
  return (
    <div className="flex flex-col min-h-screen justify-between">
      <Header heading={t('me.h1')} />
      <main>
        <div className="w-full rounded-lg border bg-gray-50 shadow-sm lg:block">
          <div className="mx-auto __flex max-w-screen-lg items-center gap-8 p-8">
            {/* <div className="grid w-2/3 grid-cols-2 gap-8"> */}
              



            <div className="isolate_ bg-white px-6 py-24 sm:py-32 lg:px-8">
                ...
                <div className="mx-auto max-w-2xl text-center">
                  <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">{t('me.h1')}</h2>
                  <p className="mt-2 text-lg leading-8 text-gray-600">{t('me.description')}</p>
                </div>
                <form action="#" method="POST" className="mx-auto mt-16 max-w-xl sm:mt-20">
                  ...
                  <div className="mt-10">
                    <button type="submit" className="block w-full rounded-md bg-indigo-600 px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Lets talk</button>
                  </div>
                </form>
              </div>
