// frontend/app/[lng]/components/Header.tsx
    ...
    <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
      <div className="flex items-center justify-between py-4 md:py-8">
        ...
        <nav className="hidden gap-12 lg:flex">
          ...
          <Link href="#" className="inline-flex items-center gap-1 text-lg font-semibold text-orange-500">
            Features
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-gray-800" viewBox="0 0 20 20" fill="currentColor">
              <path fillRule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clipRule="evenodd" />
            </svg>
          </Link>
          <Link href="#" className="text-lg font-semibold text-gray-600 transition duration-100 hover:text-orange-500 active:text-orange-700">Pricing</Link>
          <Link href="#" className="text-lg font-semibold text-gray-600 transition duration-100 hover:text-orange-500 active:text-orange-700">About</Link>
        </nav>
