...
const Home: React.FC = () => {
    ...
    return (
        <main>
            <div className="w-full rounded-lg border bg-gray-50 shadow-sm lg:block m-4__">
                <div className="mx-auto flex max-w-screen-lg items-center gap-8 p-8">
                    <div className="grid w-2/3 grid-cols-2 gap-8">
                        <Link href="#" className="group flex gap-4">
                            ...
                            <div>
                                <div className="mb-1 font-semibold">smartphones</div>
                    ...
                    <div className="w-1/3 overflow-hidden rounded-lg border">
                        ...
                        <div className="flex items-center justify-between gap-2 bg-white p-3">
                            ...
                            <Link href="#" className="inline-block shrink-0 rounded-lg border bg-white px-3 py-1 text-sm font-semibold text-orange-500 outline-none ring-orange-300 transition duration-100 hover:bg-gray-50 focus-visible:ring active:bg-gray-100">More</Link>
                        </div>
                    </div>
                </div>
            </div>
